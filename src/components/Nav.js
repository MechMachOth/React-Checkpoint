...
const Nav = ({countColor, setCountColor , setBgColor , bgColor}) => {
    return (
      <div className="text-white  flex justify-between lg:mx-[32%] p-3 border-b-[0.5px] border-gray-600">
        <div className="flex items-center">
        <h1 className=''>
        <BsCheckCircleFill className='w-5 h-5' /> 
        </h1>
        <a href="/" className='ml-2 text-xl font-bold' > Pomofocus</a>
        </div>
        <div className='flex ml-5'>
        <button className={`${countColor} mr-2 rounded flex items-center p-2`}>
